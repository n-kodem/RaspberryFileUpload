...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <meta name="author" content="Nikodem Reszka">
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <div class="d-block float-left p-3 text-white bg-dark h-100" style="width: 15%;height: 100vh !important;">
    <a href="dashboard.php" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
      <!-- <svg class="bi me-2" width="40" height="32"><use xlink:href="#bootstrap"></use></svg> -->
      <span class="h4">Hi, <?php echo htmlspecialchars($_SESSION["username"]); ?></span>
    </a>
    <hr>
  ...
  <header class="d-block p-3 bg-dark text-white float-left" style="height: fit-content;width: 85%;">
      ...
      <div class="d-flex justify-content-end align-items-end justify-content-lg-end">

        <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3 flex-fill">
          <input type="search" class="form-control form-control-dark" placeholder="Search..." aria-label="Search">
        </form>
        
        <div class="d-flex text-end flex-nowrap" style="margin-right: 0; width: fit-content; justify-items: space-around;">
